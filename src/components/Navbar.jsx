    ...
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-3">
      ...
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          <span className="font-bold">Отворено Небо</span>
        </h1>
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[15px]">
          <p className="bg-black text-white rounded-full p-2">Репертоар</p>
          <p className="p-2">За киното</p>
          <p className="p-2">Купи карти</p>
          <p className="p-2">Контакт</p>
        </div>
      </div>
      <div>
        {/* Search Bar */}
        <div className="bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[300px] lg:w-[400px]">
          ...
          <input
            ...
            type="text"
            placeholder="Пребарувај филмови"
          />
        </div>
      </div>
      {/* Card Button */}
      ...
      >
        ...
        <nav>
          <ul className="flex flex-col p-4 text-gray-800">
            ...
            <li className="text-xl py-4 flex">
              <BiSolidCameraMovie size={25} className="mr-4" />
              Најгледани филмови
            </li>
            <li className="text-xl py-4 flex">
